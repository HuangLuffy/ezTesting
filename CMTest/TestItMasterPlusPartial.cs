...
namespace CMTest
{
    ...
    {
        readonly IDictionary<string, Func<dynamic>> _optionsMasterPlusTestsWithFuncs = new Dictionary<string, Func<dynamic>>();
        ...
        private void AssembleMasterPlusPlugInOutTests()
        {
            ...
            _optionsMasterPlusTestsWithFuncs.Add(MasterPlusTestFlows.Test_Names.OPTION_LAUNCH_TEST, Flow_MasterPlus_LaunchTest);
