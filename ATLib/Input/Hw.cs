...
namespace ATLib.Input
{
    public class Hw
    {
        ...
        public class KbKeys
        {
            ...
            public static KeyPros SC_KEY_PLAY_PAUSE = new KeyPros() { ScanCode = -10, KeyValue = -10, Flag = 0, KeyCode = "MediaPlayPause", VarName = nameof(SC_KEY_PLAY_PAUSE), UiaName = "PLAY/PAUSE", Port = "" };
            public static KeyPros SC_KEY_STOP = new KeyPros() { ScanCode = -10, KeyValue = -10, Flag = 0, KeyCode = "MediaStop", VarName = nameof(SC_KEY_STOP), UiaName = "STOP", Port = "" };
            public static KeyPros SC_KEY_NEXT_TRACK = new KeyPros() { ScanCode = -10, KeyValue = -10, Flag = 0, KeyCode = "MediaNextTrack", VarName = nameof(SC_KEY_NEXT_TRACK), UiaName = "NEXT TRACK", Port = "" };
            public static KeyPros SC_KEY_PRE_TRACK = new KeyPros() { ScanCode = -10, KeyValue = -10, Flag = 0, KeyCode = "MediaPreviousTrack", VarName = nameof(SC_KEY_PRE_TRACK), UiaName = "PREVIOUS TRACK", Port = "" };
            public static KeyPros SC_KEY_VOL_INC = new KeyPros() { ScanCode = -10, KeyValue = -10, Flag = 0, KeyCode = "VolumeUp", VarName = nameof(SC_KEY_VOL_INC), UiaName = "VOLUME UP", Port = "" };
            public static KeyPros SC_KEY_VOL_DEC = new KeyPros() { ScanCode = -10, KeyValue = -10, Flag = 0, KeyCode = "VolumeDown", VarName = nameof(SC_KEY_VOL_DEC), UiaName = "VOLUME DOWN", Port = "" };
            public static KeyPros SC_KEY_MUTE = new KeyPros() { ScanCode = -10, KeyValue = -10, Flag = 0, KeyCode = "VolumeMute", VarName = nameof(SC_KEY_MUTE), UiaName = "MUTE", Port = "" };
            ...
            public static KeyPros SC_KEY_MAIL = new KeyPros() { ScanCode = -10, KeyValue = -10, Flag = 0, KeyCode = "LaunchMail", VarName = nameof(SC_KEY_MAIL), UiaName = "E-MAIL", Port = "" };
            public static KeyPros SC_KEY_CALCULATOR = new KeyPros() { ScanCode = -10, KeyValue = -10, Flag = 0, KeyCode = "LaunchApplication2", VarName = nameof(SC_KEY_CALCULATOR), UiaName = "CALCULATOR", Port = "" };
            ...
            public static KeyPros SC_KEY_W3HOME = new KeyPros() { ScanCode = -10, KeyValue = -10, Flag = 0, KeyCode = "BrowserHome", VarName = nameof(SC_KEY_W3HOME), UiaName = "WEB BROWSER", Port = "" };
