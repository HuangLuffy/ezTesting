...
namespace ATLib.Input
{
    public class Hw
    {
        ...
        public class Keys
        {
            ...
            public static KeyPros SC_KEY_NEG = new KeyPros() { ScanCode = 12, KeyValue = 189, KeyCode = "OemMinus", VarName = nameof(SC_KEY_NEG) };
            public static KeyPros SC_KEY_EQUATION = new KeyPros() { ScanCode = 13, KeyValue = 187, KeyCode = "Oemplus", VarName = nameof(SC_KEY_EQUATION) };
            public static KeyPros SC_KEY_BACKSPACE = new KeyPros() { ScanCode = 14, KeyValue = 8, KeyCode = "Back", VarName = nameof(SC_KEY_BACKSPACE) };
            public static KeyPros SC_KEY_TAB = new KeyPros() { ScanCode = 15, KeyValue = 9, KeyCode = "Tab", VarName = nameof(SC_KEY_TAB) };
            public static KeyPros SC_KEY_L_BACKETS = new KeyPros() { ScanCode = 26, KeyValue = 219, KeyCode = "OemOpenBrackets", VarName = nameof(SC_KEY_L_BACKETS) };
            public static KeyPros SC_KEY_R_BACKETS = new KeyPros() { ScanCode = 27, KeyValue = 221, KeyCode = "Oem6", VarName = nameof(SC_KEY_R_BACKETS) };
            public static KeyPros SC_KEY_BACKSLASH = new KeyPros() { ScanCode = 43, KeyValue = 220, KeyCode = "Oem5", VarName = nameof(SC_KEY_BACKSLASH) };
            public static KeyPros SC_KEY_CAP = new KeyPros() { ScanCode = 58, KeyValue = 20, KeyCode = "Capital", VarName = nameof(SC_KEY_CAP) };
            public static KeyPros SC_KEY_SEMICOLON = new KeyPros() { ScanCode = 39, KeyValue = 186, KeyCode = "Oem1", VarName = nameof(SC_KEY_SEMICOLON) };
            public static KeyPros SC_KEY_APOSTROPHE = new KeyPros() { ScanCode = 40, KeyValue = 222, KeyCode = "Oem7", VarName = nameof(SC_KEY_APOSTROPHE) };
            public static KeyPros SC_KEY_ENTER = new KeyPros() { ScanCode = 28, KeyValue = 13, KeyCode = "Return", VarName = nameof(SC_KEY_ENTER) };
            public static KeyPros SC_KEY_L_SHIFT = new KeyPros() { ScanCode = 42, KeyValue = 160, KeyCode = "LShiftKey", VarName = nameof(SC_KEY_L_SHIFT) };
            public static KeyPros SC_KEY_COMMA = new KeyPros() { ScanCode = 51, KeyValue = 188, KeyCode = "Oemcomma", VarName = nameof(SC_KEY_COMMA) };
            public static KeyPros SC_KEY_DOT = new KeyPros() { ScanCode = 52, KeyValue = 190, KeyCode = "OemPeriod", VarName = nameof(SC_KEY_DOT) };
            public static KeyPros SC_KEY_SLASH = new KeyPros() { ScanCode = 53, KeyValue = 191, KeyCode = "OemQuestion", VarName = nameof(SC_KEY_SLASH) };
            public static KeyPros SC_KEY_R_SHIFT = new KeyPros() { ScanCode = 54, KeyValue = 161, KeyCode = "RShiftKey", VarName = nameof(SC_KEY_R_SHIFT) };
            public static KeyPros SC_KEY_L_CTRL = new KeyPros() { ScanCode = 29, KeyValue = 162, KeyCode = "LControlKey", VarName = nameof(SC_KEY_L_CTRL) };
            public static KeyPros SC_KEY_L_WIN = new KeyPros() { ScanCode = 91, KeyValue = 91, KeyCode = "LWin", VarName = nameof(SC_KEY_L_WIN) };
            public static KeyPros SC_KEY_L_ALT = new KeyPros() { ScanCode = 56, KeyValue = 164, KeyCode = "LMenu", VarName = nameof(SC_KEY_L_ALT) };
            public static KeyPros SC_KEY_SPACE = new KeyPros() { ScanCode = 57, KeyValue = 32, KeyCode = "Space", VarName = nameof(SC_KEY_SPACE) };
            public static KeyPros SC_KEY_R_ALT = new KeyPros() { ScanCode = 56, KeyValue = 165, KeyCode = "RMenu", VarName = nameof(SC_KEY_R_ALT) };
            public static KeyPros SC_KEY_R_WIN = new KeyPros() { ScanCode = 92, KeyValue = 92, KeyCode = "RWin", VarName = nameof(SC_KEY_R_WIN) };
            public static KeyPros SC_KEY_R_CTRL = new KeyPros() { ScanCode = 29, KeyValue = 163, KeyCode = "RControlKey", VarName = nameof(SC_KEY_R_CTRL) };
            public static KeyPros SC_KEY_PRINT = new KeyPros() { ScanCode = 55, KeyValue = 44, KeyCode = "PrintScreen", VarName = nameof(SC_KEY_PRINT) };
            public static KeyPros SC_KEY_SCROLL = new KeyPros() { ScanCode = 70, KeyValue = 145, KeyCode = "Scroll", VarName = nameof(SC_KEY_SCROLL) };
            public static KeyPros SC_KEY_PAUSE = new KeyPros() { ScanCode = 69, KeyValue = 19, KeyCode = "Pause", VarName = nameof(SC_KEY_PAUSE) };
            public static KeyPros SC_KEY_INSERT = new KeyPros() { ScanCode = 82, KeyValue = 45, KeyCode = "Insert", VarName = nameof(SC_KEY_INSERT) };
            public static KeyPros SC_KEY_HOME = new KeyPros() { ScanCode = 71, KeyValue = 36, KeyCode = "Home", VarName = nameof(SC_KEY_HOME) };
            public static KeyPros SC_KEY_PGUP = new KeyPros() { ScanCode = 73, KeyValue = 33, KeyCode = "PageUp", VarName = nameof(SC_KEY_PGUP) };
            public static KeyPros SC_KEY_DEL = new KeyPros() { ScanCode = 83, KeyValue = 46, KeyCode = "Delete", VarName = nameof(SC_KEY_DEL) };
            public static KeyPros SC_KEY_END = new KeyPros() { ScanCode = 79, KeyValue = 35, KeyCode = "End", VarName = nameof(SC_KEY_END) };
            public static KeyPros SC_KEY_PGDN = new KeyPros() { ScanCode = 81, KeyValue = 34, KeyCode = "Next", VarName = nameof(SC_KEY_PGDN) };
            public static KeyPros SC_KEY_UP_ARROW = new KeyPros() { ScanCode = 72, KeyValue = 38, KeyCode = "Up", VarName = nameof(SC_KEY_L_ARROW) };
            public static KeyPros SC_KEY_L_ARROW = new KeyPros() { ScanCode = 75, KeyValue = 37, KeyCode = "Left", VarName = nameof(SC_KEY_A) };
            public static KeyPros SC_KEY_DN_ARROW = new KeyPros() { ScanCode = 80, KeyValue = 40, KeyCode = "Down", VarName = nameof(SC_KEY_DN_ARROW) };
            public static KeyPros SC_KEY_R_ARROW = new KeyPros() { ScanCode = 77, KeyValue = 39, KeyCode = "Right", VarName = nameof(SC_KEY_R_ARROW) };
            public static KeyPros SC_KEY_NUM_LOCK = new KeyPros() { ScanCode = 69, KeyValue = 144, KeyCode = "NumLock", VarName = nameof(SC_KEY_NUM_LOCK) };
